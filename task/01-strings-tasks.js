        ...
        for (let i=0; i<item.length; i++) {
            if (item[i].charCodeAt() >= 65 && item[i].charCodeAt() <= 90) {
                if (item[i].charCodeAt() + 13 > 90) {
                    res += String.fromCharCode(65 + ((item[i].charCodeAt() + 13) - 91) );
                } else {
                    res += String.fromCharCode(item[i].charCodeAt() + 13);
                }
            } else if (item[i].charCodeAt() >= 97 && item[i].charCodeAt() <= 122) {
                if (item[i].charCodeAt() + 13 > 122) {
                    res += String.fromCharCode(97 + ((item[i].charCodeAt() + 13) - 123) );
                } else {
                    res += String.fromCharCode(item[i].charCodeAt() + 13);
                }
            } else {
